...
setTimeout(function(){
	var should = require('should');
	var fatal = fs.readFileSync(__dirname+'/mylogs/restlog.log.1', 'utf-8');
	var error = fs.readFileSync(__dirname+'/mylogs/restlog.log.2', 'utf-8');
	var warn = fs.readFileSync(__dirname+'/mylogs/restlog.log.3', 'utf-8');
