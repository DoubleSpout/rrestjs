...
.comma-delimited {
  ...
  text-shadow: -1px -1px 1px #f00, 6px 5px 5px #ff0;
  -moz-box-shadow: 0pt 0pt 2px rgba(255,255,255,0.40) inset, 0pt 4px 6px rgba(255,255,255,0.40) inset;
}
@font-face {
